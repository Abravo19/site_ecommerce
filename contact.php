<?php
/**
 * VERTEX EXPEDITION - Page de Contact (contact.php)
...
<!-- ==========================================================================
     FORMULAIRE GRAPHIQUE DE CONTACT
     ========================================================================== -->
<div class="container-fluid px-lg-5 pb-5">
    <div class="row g-5">
        <!-- Colonne Gauche : Formulaire Graphique -->
        <div class="col-lg-7">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="contactSubject" class="form-select-tech text-secondary" required>
                                ...
                                <option value="donaciones">Information sur le 1% pour les Glaciers</option>
